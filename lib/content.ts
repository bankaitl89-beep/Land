...
export const content = {
  ...
  de: {
    ...
    hero: {
      pill: "500+ Absolventen · Ihr Zugang läuft nicht ab",
    ...
    honest: {
      ...
      text: "Es gibt keine Begrenzung bei Plätzen oder Zeit, und ich werde mir auch keine ausdenken. Der Rabatt gilt ohne Frist — ja, das heißt, es gibt ihn morgen auch noch. Mit einem Countdown werde ich Sie nicht anlügen.",
      keep: "Und das Wichtigste: was bei Ihnen bleibt. Neun Vorlagen, gebaut um Ihre eigene Arbeit. Das ist ganz normaler Text, er gehört Ihnen, er funktioniert in jedem Modell und hört nicht auf zu funktionieren, wenn Sie nie wieder zu uns zurückkommen. Der Zugang läuft nicht ab.",
    },
    pricing: {
      eyebrow: "Preis",
      title: "Ein Kurs. Ein Preis.",
      sub: "Keine Stufen, keine Nachverkäufe. Alle bekommen alles, Korrektur inklusive.",
      was: "$299",
      now: "$150",
      includes: [
        ...
        "Ihr Zugang und Ihre Vorlagen bleiben bei Ihnen",
      ],
      cta: "Anfrage senden",
    },
    form: {
