...
export const content = {
  en: {
    ...
    honest: {
      ...
      text: "There is no deadline on the discount, and I am not going to invent one — yes, that means it will still be there tomorrow. I am not going to lie to you with a countdown. Places are genuinely gone in one place only: the tier with personal guidance. That is one person's time, and it runs out.",
      keep: "And the part that matters: what stays with you. Nine setups, built around your own work. They are ordinary text, they are yours, they work in any model, and they keep working if you never come back to us. The setups stay yours for good on every tier — including the one where the course is open to you for four months.",
    },
    pricing: {
      eyebrow: "Price",
  ...
  de: {
    ...
    honest: {
      title: "Zum Rabatt, ehrlich",
      text: "Der Rabatt gilt ohne Frist, und ich werde mir auch keine ausdenken — ja, das heißt, es gibt ihn morgen auch noch. Mit einem Countdown werde ich Sie nicht anlügen. Die Plätze sind wirklich nur an einer Stelle weg: bei der Variante mit persönlicher Begleitung. Das ist die Zeit eines einzelnen Menschen, und die geht aus.",
      keep: "Und das Wichtigste: was bei Ihnen bleibt. Neun Vorlagen, gebaut um Ihre eigene Arbeit. Das ist ganz normaler Text, er gehört Ihnen, er funktioniert in jedem Modell und hört nicht auf zu funktionieren, wenn Sie nie wieder zu uns zurückkommen. Die Vorlagen bleiben in jeder Variante dauerhaft Ihre — auch in der, bei der der Kurs vier Monate lang offen ist.",
    },
    pricing: {
      eyebrow: "Preis",
  ...
  es: {
    ...
    honest: {
      ...
      text: "El descuento va sin fecha límite y no voy a inventarle una: sí, eso significa que mañana también estará. No pienso engañarle con una cuenta atrás. Las plazas se han acabado de verdad en un solo sitio: la opción con acompañamiento personal. Es el tiempo de una sola persona, y se termina.",
      keep: "Y lo que de verdad importa: lo que se queda con usted. Nueve plantillas hechas para su trabajo. Son texto corriente, son suyas, funcionan en cualquier modelo y seguirán funcionando aunque no vuelva nunca. Las plantillas se quedan suyas para siempre en cualquier opción, incluida aquella en la que el curso está abierto cuatro meses.",
    },
    pricing: {
      eyebrow: "Precio",
  ...
  ru: {
    ...
    honest: {
      ...
      text: "Скидка действует без дедлайна, и придумывать его я не стану — да, это значит, что завтра она тоже будет. Обманывать вас таймером я не собираюсь. Места закончились по-настоящему ровно в одном варианте — там, где есть личное ведение. Это время одного человека, и оно кончается.",
      keep: "И главное — то, что остаётся у вас. Девять заготовок под вашу работу. Это обычный текст, он ваш, работает в любой модели и не перестанет работать, если вы к нам больше не вернётесь. Заготовки остаются вашими навсегда в любом варианте — в том числе в том, где курс открыт на четыре месяца.",
    },
    pricing: {
      eyebrow: "Цена",
